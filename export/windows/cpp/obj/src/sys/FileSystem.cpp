...
bool FileSystem_obj::exists( ::String path){
	HX_STACK_FRAME("sys.FileSystem","exists",0xf55bed9e,"sys.FileSystem.exists","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",33,0xb88d2928)
...
Dynamic FileSystem_obj::stat( ::String path){
	HX_STACK_FRAME("sys.FileSystem","stat",0xa630df16,"sys.FileSystem.stat","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",42,0xb88d2928)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(43)
	::String tmp = path;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(43)
	...
	if ((tmp2)){
		...
		struct _Function_2_1{
			inline static Dynamic Block( ::Date &tmp5,::Date &tmp4,::Date &tmp3){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",45,0xb88d2928)
				{
...
::String FileSystem_obj::fullPath( ::String relPath){
	HX_STACK_FRAME("sys.FileSystem","fullPath",0xc6463316,"sys.FileSystem.fullPath","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",52,0xb88d2928)
...
{
		HX_STACK_FRAME("sys.FileSystem","createDirectory",0x63bad3cf,"sys.FileSystem.createDirectory","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",74,0xb88d2928)
		HX_STACK_ARG(path,"path")
		HX_STACK_LINE(75)
		::String tmp = path;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(75)
...
{
		HX_STACK_FRAME("sys.FileSystem","deleteFile",0x4bd48509,"sys.FileSystem.deleteFile","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",88,0xb88d2928)
		HX_STACK_ARG(path,"path")
		HX_STACK_LINE(89)
		::String tmp = path;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(89)
