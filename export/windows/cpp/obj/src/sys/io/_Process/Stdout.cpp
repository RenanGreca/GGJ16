...
{
HX_STACK_FRAME("sys.io._Process.Stdout","new",0xc765a8f4,"sys.io._Process.Stdout.new","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/Process.hx",64,0x1b6452cd)
HX_STACK_THIS(this)
HX_STACK_ARG(p,"p")
...
int Stdout_obj::readByte( ){
	HX_STACK_FRAME("sys.io._Process.Stdout","readByte",0xa72b886a,"sys.io._Process.Stdout.readByte","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/Process.hx",70,0x1b6452cd)
	HX_STACK_THIS(this)
	HX_STACK_LINE(71)
...
int Stdout_obj::readBytes( ::haxe::io::Bytes str,int pos,int len){
	HX_STACK_FRAME("sys.io._Process.Stdout","readBytes",0x9eebd4c9,"sys.io._Process.Stdout.readBytes","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/Process.hx",76,0x1b6452cd)
	HX_STACK_THIS(this)
