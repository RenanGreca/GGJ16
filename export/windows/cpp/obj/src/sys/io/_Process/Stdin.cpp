...
{
HX_STACK_FRAME("sys.io._Process.Stdin","new",0xd3131563,"sys.io._Process.Stdin.new","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/Process.hx",29,0x1b6452cd)
HX_STACK_THIS(this)
HX_STACK_ARG(p,"p")
{
	HX_STACK_LINE(30)
...
{
		HX_STACK_FRAME("sys.io._Process.Stdin","close",0xbd3fe37b,"sys.io._Process.Stdin.close","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/Process.hx",34,0x1b6452cd)
		HX_STACK_THIS(this)
		HX_STACK_LINE(35)
		this->super::close();
		HX_STACK_LINE(36)
...
{
		HX_STACK_FRAME("sys.io._Process.Stdin","writeByte",0xfb987cca,"sys.io._Process.Stdin.writeByte","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/Process.hx",39,0x1b6452cd)
		HX_STACK_THIS(this)
		HX_STACK_ARG(c,"c")
		HX_STACK_LINE(40)
		{
...
int Stdin_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
	HX_STACK_FRAME("sys.io._Process.Stdin","writeBytes",0x29d4b469,"sys.io._Process.Stdin.writeBytes","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/Process.hx",44,0x1b6452cd)
	HX_STACK_THIS(this)
