...
{
HX_STACK_FRAME("sys.io.FileOutput","new",0x19e22a16,"sys.io.FileOutput.new","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/FileOutput.hx",31,0x2352afe3)
HX_STACK_THIS(this)
HX_STACK_ARG(f,"f")
{
	HX_STACK_LINE(31)
...
{
		HX_STACK_FRAME("sys.io.FileOutput","writeByte",0x887099bd,"sys.io.FileOutput.writeByte","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/FileOutput.hx",35,0x2352afe3)
		HX_STACK_THIS(this)
		HX_STACK_ARG(c,"c")
		HX_STACK_LINE(35)
		try
...
int FileOutput_obj::writeBytes( ::haxe::io::Bytes s,int p,int l){
	HX_STACK_FRAME("sys.io.FileOutput","writeBytes",0xda15ec16,"sys.io.FileOutput.writeBytes","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/FileOutput.hx",38,0x2352afe3)
	HX_STACK_THIS(this)
	HX_STACK_ARG(s,"s")
	HX_STACK_ARG(p,"p")
	HX_STACK_ARG(l,"l")
...
{
		HX_STACK_FRAME("sys.io.FileOutput","close",0xa583caee,"sys.io.FileOutput.close","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/FileOutput.hx",46,0x2352afe3)
		HX_STACK_THIS(this)
		HX_STACK_LINE(47)
		this->super::close();
		HX_STACK_LINE(48)
