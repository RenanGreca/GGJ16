...
::String File_obj::getContent( ::String path){
	HX_STACK_FRAME("sys.io.File","getContent",0xb28b4a0e,"sys.io.File.getContent","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/File.hx",27,0x138ae7e4)
...
::haxe::io::Bytes File_obj::getBytes( ::String path){
	HX_STACK_FRAME("sys.io.File","getBytes",0xbe457600,"sys.io.File.getBytes","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/File.hx",32,0x138ae7e4)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(33)
	::String tmp = path;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(33)
...
bool binary = __o_binary.Default(true);
	HX_STACK_FRAME("sys.io.File","write",0xfec8a9f4,"sys.io.File.write","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/File.hx",53,0x138ae7e4)
	HX_STACK_ARG(path,"path")
