...
Void FlxGame_obj::create( Dynamic _){
{
		...
		HX_STACK_LINE(282)
		::flixel::_system::debug::FlxDebugger tmp17 = ::flixel::_system::debug::FlxDebugger_obj::__new(tmp13,tmp16);		HX_STACK_VAR(tmp17,"tmp17");
		HX_STACK_LINE(282)
		this->debugger = tmp17;
		HX_STACK_LINE(283)
		::flixel::_system::debug::FlxDebugger tmp18 = this->debugger;		HX_STACK_VAR(tmp18,"tmp18");
		HX_STACK_LINE(283)
		this->addChild(tmp18);
		HX_STACK_LINE(290)
		::hx::Class tmp19 = this->_customSoundTray;		HX_STACK_VAR(tmp19,"tmp19");
		HX_STACK_LINE(290)
		::flixel::_system::ui::FlxSoundTray tmp20 = ::Type_obj::createInstance(tmp19,cpp::ArrayBase_obj::__new());		HX_STACK_VAR(tmp20,"tmp20");
		HX_STACK_LINE(290)
		this->soundTray = tmp20;
		HX_STACK_LINE(291)
		::flixel::_system::ui::FlxSoundTray tmp21 = this->soundTray;		HX_STACK_VAR(tmp21,"tmp21");
		HX_STACK_LINE(291)
		this->addChild(tmp21);
		HX_STACK_LINE(295)
		::hx::Class tmp22 = this->_customFocusLostScreen;		HX_STACK_VAR(tmp22,"tmp22");
		HX_STACK_LINE(295)
		::flixel::_system::ui::FlxFocusLostScreen tmp23 = ::Type_obj::createInstance(tmp22,cpp::ArrayBase_obj::__new());		HX_STACK_VAR(tmp23,"tmp23");
		HX_STACK_LINE(295)
		this->_focusLostScreen = tmp23;
		HX_STACK_LINE(296)
		::flixel::_system::ui::FlxFocusLostScreen tmp24 = this->_focusLostScreen;		HX_STACK_VAR(tmp24,"tmp24");
		HX_STACK_LINE(296)
		this->addChild(tmp24);
		HX_STACK_LINE(302)
		::openfl::_legacy::display::Stage tmp25 = this->get_stage();		HX_STACK_VAR(tmp25,"tmp25");
		HX_STACK_LINE(302)
		Dynamic tmp26 = this->onFocusLost_dyn();		HX_STACK_VAR(tmp26,"tmp26");
		HX_STACK_LINE(302)
		tmp25->addEventListener(HX_HCSTRING("focusOut","\x96","\x6f","\x5e","\x11"),tmp26,null(),null(),null());
		HX_STACK_LINE(303)
		::openfl::_legacy::display::Stage tmp27 = this->get_stage();		HX_STACK_VAR(tmp27,"tmp27");
		HX_STACK_LINE(303)
		Dynamic tmp28 = this->onFocus_dyn();		HX_STACK_VAR(tmp28,"tmp28");
		HX_STACK_LINE(303)
		tmp27->addEventListener(HX_HCSTRING("focusIn","\xdd","\x45","\x83","\x41"),tmp28,null(),null(),null());
		HX_STACK_LINE(310)
		{
			HX_STACK_LINE(310)
			::flixel::_system::frontEnds::SignalFrontEnd tmp29 = ::flixel::FlxG_obj::signals;		HX_STACK_VAR(tmp29,"tmp29");
			HX_STACK_LINE(310)
			tmp29->__Field(HX_HCSTRING("gameReset","\x7d","\x38","\xe3","\x1b"), hx::paccDynamic )->__Field(HX_HCSTRING("dispatch","\xba","\xce","\x63","\x1e"), hx::paccDynamic )();
			HX_STACK_LINE(310)
			this->_skipSplash = true;
			HX_STACK_LINE(310)
			bool tmp30 = this->_skipSplash;		HX_STACK_VAR(tmp30,"tmp30");
			HX_STACK_LINE(310)
			...
			if ((tmp31)){
				HX_STACK_LINE(310)
				::hx::Class tmp33 = ::flixel::_system::FlxSplash_obj::nextState;		HX_STACK_VAR(tmp33,"tmp33");
				HX_STACK_LINE(310)
				::hx::Class tmp34 = tmp33;		HX_STACK_VAR(tmp34,"tmp34");
				HX_STACK_LINE(310)
				tmp32 = (tmp34 != null());
			}
			else{
			...
			if ((tmp32)){
				HX_STACK_LINE(310)
				::hx::Class tmp33 = this->_initialState;		HX_STACK_VAR(tmp33,"tmp33");
				HX_STACK_LINE(310)
				::flixel::FlxState tmp34 = ::Type_obj::createInstance(tmp33,cpp::ArrayBase_obj::__new());		HX_STACK_VAR(tmp34,"tmp34");
				HX_STACK_LINE(310)
				this->_requestedState = tmp34;
				HX_STACK_LINE(310)
				::hx::Class tmp35 = ::flixel::_system::FlxSplash_obj::nextState;		HX_STACK_VAR(tmp35,"tmp35");
				HX_STACK_LINE(310)
				...
				::hx::Class tmp33 = this->_initialState;		HX_STACK_VAR(tmp33,"tmp33");
				HX_STACK_LINE(310)
				::flixel::_system::FlxSplash_obj::nextState = tmp33;
				HX_STACK_LINE(310)
				::flixel::_system::FlxSplash tmp34 = ::flixel::_system::FlxSplash_obj::__new(null());		HX_STACK_VAR(tmp34,"tmp34");
				HX_STACK_LINE(310)
				this->_requestedState = tmp34;
				HX_STACK_LINE(310)
				this->_skipSplash = true;
			...
			HX_STACK_LINE(310)
			::flixel::FlxState tmp33 = this->_requestedState;		HX_STACK_VAR(tmp33,"tmp33");
			HX_STACK_LINE(310)
			bool tmp34 = ::Std_obj::is(tmp33,hx::ClassOf< ::flixel::FlxSubState >());		HX_STACK_VAR(tmp34,"tmp34");
			HX_STACK_LINE(310)
			if ((tmp34)){
				HX_STACK_LINE(310)
				HX_STACK_DO_THROW(HX_HCSTRING("You can't set FlxSubState class instance as the state for you game","\xf2","\x8e","\x2c","\x80"));
			}
			HX_STACK_LINE(310)
		...
		HX_STACK_LINE(313)
		int tmp30 = tmp29->_stepMS;		HX_STACK_VAR(tmp30,"tmp30");
		HX_STACK_LINE(313)
		Float tmp31 = (Float((int)1000) / Float(tmp30));		HX_STACK_VAR(tmp31,"tmp31");
		HX_STACK_LINE(313)
		int tmp32 = ::Std_obj::_int(tmp31);		HX_STACK_VAR(tmp32,"tmp32");
		HX_STACK_LINE(313)
		int tmp33 = ::flixel::FlxG_obj::drawFramerate;		HX_STACK_VAR(tmp33,"tmp33");
		HX_STACK_LINE(313)
		bool tmp34 = (tmp32 < tmp33);		HX_STACK_VAR(tmp34,"tmp34");
		HX_STACK_LINE(313)
		if ((tmp34)){
			HX_STACK_LINE(315)
			::flixel::_system::frontEnds::LogFrontEnd tmp35 = ::flixel::FlxG_obj::log;		HX_STACK_VAR(tmp35,"tmp35");
			HX_STACK_LINE(315)
			::flixel::_system::debug::LogStyle tmp36 = ::flixel::_system::debug::LogStyle_obj::WARNING;		HX_STACK_VAR(tmp36,"tmp36");
			HX_STACK_LINE(315)
			tmp35->__Field(HX_HCSTRING("advanced","\xa2","\x69","\x7b","\x3b"), hx::paccDynamic )(HX_HCSTRING("FlxG.updateFramerate: The update framerate shouldn't be smaller than the draw framerate, since it can slow down your game.","\x81","\x2e","\x69","\x6b"),tmp36,true);
		}
		HX_STACK_LINE(319)
		::openfl::_legacy::display::Stage tmp35 = this->get_stage();		HX_STACK_VAR(tmp35,"tmp35");
		HX_STACK_LINE(319)
		::String tmp36 = ::openfl::_legacy::events::Event_obj::ENTER_FRAME;		HX_STACK_VAR(tmp36,"tmp36");
		HX_STACK_LINE(319)
		Dynamic tmp37 = this->onEnterFrame_dyn();		HX_STACK_VAR(tmp37,"tmp37");
		HX_STACK_LINE(319)
		tmp35->addEventListener(tmp36,tmp37,null(),null(),null());
		HX_STACK_LINE(323)
		::openfl::_legacy::display::Stage tmp38 = this->get_stage();		HX_STACK_VAR(tmp38,"tmp38");
		HX_STACK_LINE(323)
		::String tmp39 = ::openfl::_legacy::events::Event_obj::RESIZE;		HX_STACK_VAR(tmp39,"tmp39");
		HX_STACK_LINE(323)
		Dynamic tmp40 = this->onResize_dyn();		HX_STACK_VAR(tmp40,"tmp40");
		HX_STACK_LINE(323)
		tmp38->addEventListener(tmp39,tmp40,null(),null(),null());
		HX_STACK_LINE(326)
		::openfl::_legacy::display::MovieClip tmp41 = ::openfl::_legacy::Lib_obj::get_current();		HX_STACK_VAR(tmp41,"tmp41");
		HX_STACK_LINE(326)
		::openfl::_legacy::display::Stage tmp42 = tmp41->get_stage();		HX_STACK_VAR(tmp42,"tmp42");
		HX_STACK_LINE(326)
		int tmp43 = tmp42->get_stageWidth();		HX_STACK_VAR(tmp43,"tmp43");
		HX_STACK_LINE(326)
		::openfl::_legacy::display::MovieClip tmp44 = ::openfl::_legacy::Lib_obj::get_current();		HX_STACK_VAR(tmp44,"tmp44");
		HX_STACK_LINE(326)
		::openfl::_legacy::display::Stage tmp45 = tmp44->get_stage();		HX_STACK_VAR(tmp45,"tmp45");
		HX_STACK_LINE(326)
		int tmp46 = tmp45->get_stageHeight();		HX_STACK_VAR(tmp46,"tmp46");
		HX_STACK_LINE(326)
		this->resizeGame(tmp43,tmp46);
	}
return null();
}
...
Void FlxGame_obj::onFocus( Dynamic _){
{
		...
		HX_STACK_LINE(364)
		::flixel::_system::debug::FlxDebugger tmp7 = this->debugger;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(364)
		tmp7->__Field(HX_HCSTRING("stats","\x1f","\x76","\x0b","\x84"), hx::paccDynamic )->__Field(HX_HCSTRING("onFocus","\x39","\xfe","\xc6","\x9a"), hx::paccDynamic )();
		HX_STACK_LINE(367)
		::openfl::_legacy::display::Stage tmp8 = this->get_stage();		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(367)
		int tmp9 = ::flixel::FlxG_obj::drawFramerate;		HX_STACK_VAR(tmp9,"tmp9");
		...
		HX_STACK_LINE(371)
		{
			...
			HX_STACK_LINE(371)
			Array< ::flixel::interfaces::IFlxInput > _g1 = tmp11->__Field(HX_HCSTRING("list","\x5e","\x1c","\xb3","\x47"), hx::paccDynamic );		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(371)
			while((true)){
				HX_STACK_LINE(371)
				...
				HX_STACK_LINE(371)
				::flixel::interfaces::IFlxInput tmp14 = _g1->__get(_g);		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(371)
				::flixel::interfaces::IFlxInput input = tmp14;		HX_STACK_VAR(input,"input");
				HX_STACK_LINE(371)
				++(_g);
				HX_STACK_LINE(371)
				input->onFocus();
...
Void FlxGame_obj::onFocusLost( Dynamic _){
{
		...
		HX_STACK_LINE(400)
		::flixel::_system::debug::FlxDebugger tmp5 = this->debugger;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(400)
		tmp5->__Field(HX_HCSTRING("stats","\x1f","\x76","\x0b","\x84"), hx::paccDynamic )->__Field(HX_HCSTRING("onFocusLost","\xbd","\xe4","\x85","\x41"), hx::paccDynamic )();
		HX_STACK_LINE(403)
		::openfl::_legacy::display::Stage tmp6 = this->get_stage();		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(403)
		...
		HX_STACK_LINE(407)
		{
			...
			HX_STACK_LINE(407)
			Array< ::flixel::interfaces::IFlxInput > _g1 = tmp9->__Field(HX_HCSTRING("list","\x5e","\x1c","\xb3","\x47"), hx::paccDynamic );		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(407)
			while((true)){
				HX_STACK_LINE(407)
				...
				HX_STACK_LINE(407)
				::flixel::interfaces::IFlxInput tmp12 = _g1->__get(_g);		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(407)
				::flixel::interfaces::IFlxInput input = tmp12;		HX_STACK_VAR(input,"input");
				HX_STACK_LINE(407)
				++(_g);
				HX_STACK_LINE(407)
				input->onFocusLost();
...
Void FlxGame_obj::resizeGame( int width,int height){
{
		...
		HX_STACK_LINE(432)
		::flixel::_system::debug::FlxDebugger tmp = this->debugger;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(432)
		int tmp1 = width;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(432)
		int tmp2 = height;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(432)
		tmp->__Field(HX_HCSTRING("onResize","\x73","\x50","\x28","\xe8"), hx::paccDynamic )(tmp1,tmp2);
		HX_STACK_LINE(436)
		::flixel::_system::ui::FlxFocusLostScreen tmp3 = this->_focusLostScreen;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(436)
		bool tmp4 = (tmp3 != null());		HX_STACK_VAR(tmp4,"tmp4");
		...
		if ((tmp4)){
			...
			::flixel::_system::ui::FlxFocusLostScreen tmp5 = this->_focusLostScreen;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(438)
			tmp5->__Field(HX_HCSTRING("draw","\x04","\x2c","\x70","\x42"), hx::paccDynamic )();
		}
		HX_STACK_LINE(443)
		...
		if ((tmp6)){
			...
			HX_STACK_LINE(445)
			tmp7->__Field(HX_HCSTRING("screenCenter","\x61","\x2e","\xf9","\xe2"), hx::paccDynamic )();
		}
		HX_STACK_LINE(449)
		::openfl::_legacy::display::Sprite tmp7 = this->_inputContainer;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(449)
		::flixel::FlxGame tmp8 = ::flixel::FlxG_obj::game;		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(449)
		Float tmp9 = tmp8->get_scaleX();		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(449)
		Float tmp10 = (Float((int)1) / Float(tmp9));		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(449)
		tmp7->set_scaleX(tmp10);
		HX_STACK_LINE(450)
		::openfl::_legacy::display::Sprite tmp11 = this->_inputContainer;		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(450)
		::flixel::FlxGame tmp12 = ::flixel::FlxG_obj::game;		HX_STACK_VAR(tmp12,"tmp12");
		HX_STACK_LINE(450)
		Float tmp13 = tmp12->get_scaleY();		HX_STACK_VAR(tmp13,"tmp13");
		HX_STACK_LINE(450)
		Float tmp14 = (Float((int)1) / Float(tmp13));		HX_STACK_VAR(tmp14,"tmp14");
		HX_STACK_LINE(450)
		tmp11->set_scaleY(tmp14);
	}
return null();
}
...
Void FlxGame_obj::onEnterFrame( Dynamic _){
{
		...
		if ((tmp12)){
			...
			this->draw();
			HX_STACK_LINE(509)
			::flixel::_system::debug::FlxDebugger tmp16 = this->debugger;		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(509)
			int tmp17 = ::flixel::FlxBasic_obj::_VISIBLECOUNT;		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(509)
			tmp16->__Field(HX_HCSTRING("stats","\x1f","\x76","\x0b","\x84"), hx::paccDynamic )->__Field(HX_HCSTRING("visibleObjects","\x82","\xea","\xf1","\x36"), hx::paccDynamic )(tmp17);
			HX_STACK_LINE(510)
			::flixel::_system::debug::FlxDebugger tmp18 = this->debugger;		HX_STACK_VAR(tmp18,"tmp18");
			HX_STACK_LINE(510)
			tmp18->__Field(HX_HCSTRING("update","\x09","\x86","\x05","\x87"), hx::paccDynamic )();
		}
	}
return null();
}
...
Void FlxGame_obj::resetGame( ){
{
		...
		HX_STACK_LINE(543)
		::flixel::FlxState tmp4 = this->_requestedState;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(543)
		bool tmp5 = ::Std_obj::is(tmp4,hx::ClassOf< ::flixel::FlxSubState >());		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(543)
		if ((tmp5)){
			HX_STACK_LINE(545)
			HX_STACK_DO_THROW(HX_HCSTRING("You can't set FlxSubState class instance as the state for you game","\xf2","\x8e","\x2c","\x80"));
...
Void FlxGame_obj::switchState( ){
{
		...
		HX_STACK_LINE(591)
		{
			...
			HX_STACK_LINE(591)
			::flixel::_system::debug::FlxDebugger tmp11 = this->debugger;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(591)
			::haxe::ds::StringMap tmp12 = tmp11->__Field(HX_HCSTRING("console","\x57","\xeb","\xd5","\x18"), hx::paccDynamic )->__Field(HX_HCSTRING("registeredObjects","\x72","\x87","\x9b","\x2a"), hx::paccDynamic );		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(591)
			Dynamic tmp13 = value;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(591)
			tmp12->set(HX_HCSTRING("state","\x11","\x76","\x0b","\x84"),tmp13);
		}
	}
return null();
}
...
Void FlxGame_obj::step( ){
{
		...
		if ((tmp)){
			HX_STACK_LINE(612)
			{
				...
				HX_STACK_LINE(612)
				::flixel::FlxState tmp5 = this->_requestedState;		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(612)
				bool tmp6 = ::Std_obj::is(tmp5,hx::ClassOf< ::flixel::FlxSubState >());		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(612)
				if ((tmp6)){
					HX_STACK_LINE(612)
					HX_STACK_DO_THROW(HX_HCSTRING("You can't set FlxSubState class instance as the state for you game","\xf2","\x8e","\x2c","\x80"));
		...
		this->update();
		HX_STACK_LINE(651)
		::flixel::_system::debug::FlxDebugger tmp1 = this->debugger;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(651)
		int tmp2 = ::flixel::FlxBasic_obj::_ACTIVECOUNT;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(651)
		tmp1->__Field(HX_HCSTRING("stats","\x1f","\x76","\x0b","\x84"), hx::paccDynamic )->__Field(HX_HCSTRING("activeObjects","\xae","\xb3","\x18","\x3a"), hx::paccDynamic )(tmp2);
	}
return null();
}
...
Void FlxGame_obj::update( ){
{
		...
		HX_STACK_LINE(672)
		::flixel::_system::frontEnds::DebuggerFrontEnd tmp9 = ::flixel::FlxG_obj::debugger;		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(672)
		bool tmp10 = tmp9->__Field(HX_HCSTRING("visible","\x72","\x78","\x24","\xa3"), hx::paccDynamic );		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(672)
		if ((tmp10)){
			HX_STACK_LINE(674)
		...
		HX_STACK_LINE(678)
		tmp11->__Field(HX_HCSTRING("preUpdate","\x8c","\x96","\xa6","\xe5"), hx::paccDynamic )->__Field(HX_HCSTRING("dispatch","\xba","\xce","\x63","\x1e"), hx::paccDynamic )();
		HX_STACK_LINE(680)
		bool tmp12 = ::flixel::FlxG_obj::fixedTimestep;		HX_STACK_VAR(tmp12,"tmp12");
		HX_STACK_LINE(680)
		if ((tmp12)){
			HX_STACK_LINE(682)
			Float tmp13 = ::flixel::FlxG_obj::timeScale;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(682)
			Float tmp14 = this->_stepSeconds;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(682)
			Float tmp15 = (tmp13 * tmp14);		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(682)
			::flixel::FlxG_obj::elapsed = tmp15;
		}
		else{
			HX_STACK_LINE(686)
			Float tmp13 = ::flixel::FlxG_obj::timeScale;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(686)
			int tmp14 = this->_elapsedMS;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(686)
			Float tmp15 = (Float(tmp14) / Float((int)1000));		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(686)
			Float tmp16 = (tmp13 * tmp15);		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(686)
			::flixel::FlxG_obj::elapsed = tmp16;
			HX_STACK_LINE(688)
			Float tmp17 = ::flixel::FlxG_obj::maxElapsed;		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(688)
			Float tmp18 = ::flixel::FlxG_obj::timeScale;		HX_STACK_VAR(tmp18,"tmp18");
			HX_STACK_LINE(688)
			Float tmp19 = (tmp17 * tmp18);		HX_STACK_VAR(tmp19,"tmp19");
			HX_STACK_LINE(688)
			Float max = tmp19;		HX_STACK_VAR(max,"max");
			HX_STACK_LINE(689)
			Float tmp20 = ::flixel::FlxG_obj::elapsed;		HX_STACK_VAR(tmp20,"tmp20");
			HX_STACK_LINE(689)
			Float tmp21 = max;		HX_STACK_VAR(tmp21,"tmp21");
			HX_STACK_LINE(689)
			bool tmp22 = (tmp20 > tmp21);		HX_STACK_VAR(tmp22,"tmp22");
			HX_STACK_LINE(689)
			if ((tmp22)){
		...
		HX_STACK_LINE(696)
		tmp13->__Field(HX_HCSTRING("update","\x09","\x86","\x05","\x87"), hx::paccDynamic )();
		HX_STACK_LINE(698)
		{
			HX_STACK_LINE(698)
			int _g = (int)0;		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(698)
			::flixel::_system::frontEnds::PluginFrontEnd tmp14 = ::flixel::FlxG_obj::plugins;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(698)
			Array< ::Dynamic > _g1 = tmp14->__Field(HX_HCSTRING("list","\x5e","\x1c","\xb3","\x47"), hx::paccDynamic );		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(698)
			while((true)){
				HX_STACK_LINE(698)
				...
				HX_STACK_LINE(698)
				::flixel::plugin::FlxPlugin tmp17 = _g1->__get(_g).StaticCast< ::flixel::plugin::FlxPlugin >();		HX_STACK_VAR(tmp17,"tmp17");
				HX_STACK_LINE(698)
				::flixel::plugin::FlxPlugin plugin = tmp17;		HX_STACK_VAR(plugin,"plugin");
				HX_STACK_LINE(698)
				++(_g);
				HX_STACK_LINE(698)
				bool tmp18 = plugin->exists;		HX_STACK_VAR(tmp18,"tmp18");
				HX_STACK_LINE(698)
		...
		HX_STACK_LINE(702)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(702)
				::flixel::FlxCamera tmp18 = _g1->__get(_g).StaticCast< ::flixel::FlxCamera >();		HX_STACK_VAR(tmp18,"tmp18");
				HX_STACK_LINE(702)
				::flixel::FlxCamera camera = tmp18;		HX_STACK_VAR(camera,"camera");
				HX_STACK_LINE(702)
				++(_g);
				HX_STACK_LINE(702)
				bool tmp19 = (camera != null());		HX_STACK_VAR(tmp19,"tmp19");
				HX_STACK_LINE(702)
				...
				if ((tmp20)){
					HX_STACK_LINE(702)
					bool tmp21 = camera->active;		HX_STACK_VAR(tmp21,"tmp21");
					HX_STACK_LINE(702)
					if ((tmp21)){
						HX_STACK_LINE(702)
						camera->update();
					...
					HX_STACK_LINE(702)
					Float tmp22 = camera->x;		HX_STACK_VAR(tmp22,"tmp22");
					HX_STACK_LINE(702)
					Float tmp23 = camera->_flashOffset->x;		HX_STACK_VAR(tmp23,"tmp23");
					HX_STACK_LINE(702)
					Float tmp24 = (tmp22 + tmp23);		HX_STACK_VAR(tmp24,"tmp24");
					HX_STACK_LINE(702)
					camera->flashSprite->set_x(tmp24);
					HX_STACK_LINE(702)
					Float tmp25 = camera->y;		HX_STACK_VAR(tmp25,"tmp25");
					HX_STACK_LINE(702)
					Float tmp26 = camera->_flashOffset->y;		HX_STACK_VAR(tmp26,"tmp26");
					HX_STACK_LINE(702)
					Float tmp27 = (tmp25 + tmp26);		HX_STACK_VAR(tmp27,"tmp27");
					HX_STACK_LINE(702)
					camera->flashSprite->set_y(tmp27);
					HX_STACK_LINE(702)
					bool tmp28 = camera->visible;		HX_STACK_VAR(tmp28,"tmp28");
					HX_STACK_LINE(702)
					camera->flashSprite->set_visible(tmp28);
				}
			}
		}
		HX_STACK_LINE(703)
		...
		HX_STACK_LINE(703)
		tmp15->__Field(HX_HCSTRING("postUpdate","\x89","\x06","\x3e","\xdc"), hx::paccDynamic )->__Field(HX_HCSTRING("dispatch","\xba","\xce","\x63","\x1e"), hx::paccDynamic )();
		HX_STACK_LINE(706)
		::flixel::_system::debug::FlxDebugger tmp16 = this->debugger;		HX_STACK_VAR(tmp16,"tmp16");
		HX_STACK_LINE(706)
		int tmp17 = ::openfl::_legacy::Lib_obj::getTimer();		HX_STACK_VAR(tmp17,"tmp17");
		HX_STACK_LINE(706)
		int tmp18 = this->ticks;		HX_STACK_VAR(tmp18,"tmp18");
		HX_STACK_LINE(706)
		int tmp19 = (tmp17 - tmp18);		HX_STACK_VAR(tmp19,"tmp19");
		HX_STACK_LINE(706)
		tmp16->__Field(HX_HCSTRING("stats","\x1f","\x76","\x0b","\x84"), hx::paccDynamic )->__Field(HX_HCSTRING("flixelUpdate","\x85","\x69","\x5e","\x27"), hx::paccDynamic )(tmp19);
		HX_STACK_LINE(710)
		{
			HX_STACK_LINE(710)
			int _g = (int)0;		HX_STACK_VAR(_g,"_g");
			...
			while((true)){
				...
				HX_STACK_LINE(710)
				::flixel::input::FlxSwipe tmp22 = _g1->__get(_g).StaticCast< ::flixel::input::FlxSwipe >();		HX_STACK_VAR(tmp22,"tmp22");
				HX_STACK_LINE(710)
				::flixel::input::FlxSwipe swipe = tmp22;		HX_STACK_VAR(swipe,"swipe");
				HX_STACK_LINE(710)
				++(_g);
				HX_STACK_LINE(712)
				swipe = null();
...
Void FlxGame_obj::draw( ){
{
		...
		HX_STACK_LINE(788)
		::flixel::_system::frontEnds::DebuggerFrontEnd tmp6 = ::flixel::FlxG_obj::debugger;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(788)
		bool tmp7 = tmp6->__Field(HX_HCSTRING("visible","\x72","\x78","\x24","\xa3"), hx::paccDynamic );		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(788)
		if ((tmp7)){
			HX_STACK_LINE(791)
			int tmp8 = ::openfl::_legacy::Lib_obj::getTimer();		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(791)
			this->ticks = tmp8;
		}
		HX_STACK_LINE(795)
		...
		HX_STACK_LINE(795)
		tmp8->__Field(HX_HCSTRING("preDraw","\xc7","\x05","\xd5","\x1a"), hx::paccDynamic )->__Field(HX_HCSTRING("dispatch","\xba","\xce","\x63","\x1e"), hx::paccDynamic )();
		HX_STACK_LINE(798)
		...
		HX_STACK_LINE(801)
		{
			...
			HX_STACK_LINE(801)
			Array< ::Dynamic > _g1 = tmp9->__Field(HX_HCSTRING("list","\x5e","\x1c","\xb3","\x47"), hx::paccDynamic );		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(801)
			while((true)){
				HX_STACK_LINE(801)
				bool tmp10 = (_g < _g1->length);		HX_STACK_VAR(tmp10,"tmp10");
				...
				++(_g);
				HX_STACK_LINE(801)
				bool tmp13 = (camera == null());		HX_STACK_VAR(tmp13,"tmp13");
				HX_STACK_LINE(801)
				bool tmp14 = !(tmp13);		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(801)
				bool tmp15 = tmp14;		HX_STACK_VAR(tmp15,"tmp15");
				...
				if ((tmp17)){
					HX_STACK_LINE(801)
					bool tmp19 = camera->visible;		HX_STACK_VAR(tmp19,"tmp19");
					HX_STACK_LINE(801)
				...
				HX_STACK_LINE(801)
				::openfl::_legacy::display::Graphics tmp19 = camera->canvas->get_graphics();		HX_STACK_VAR(tmp19,"tmp19");
				HX_STACK_LINE(801)
				tmp19->clear();
				HX_STACK_LINE(801)
				::openfl::_legacy::display::Graphics tmp20 = camera->debugLayer->get_graphics();		HX_STACK_VAR(tmp20,"tmp20");
				HX_STACK_LINE(801)
				tmp20->clear();
				HX_STACK_LINE(801)
				int tmp21 = (int(camera->bgColor) & int((int)16777215));		HX_STACK_VAR(tmp21,"tmp21");
				HX_STACK_LINE(801)
				bool tmp22 = camera->useBgAlphaBlending;		HX_STACK_VAR(tmp22,"tmp22");
				HX_STACK_LINE(801)
				int tmp23 = (int(camera->bgColor) >> int((int)24));		HX_STACK_VAR(tmp23,"tmp23");
				HX_STACK_LINE(801)
				int tmp24 = (int(tmp23) & int((int)255));		HX_STACK_VAR(tmp24,"tmp24");
				HX_STACK_LINE(801)
				Float tmp25 = (Float(tmp24) / Float((int)255));		HX_STACK_VAR(tmp25,"tmp25");
				HX_STACK_LINE(801)
				camera->fill(tmp21,tmp22,tmp25,null());
			}
		}
		HX_STACK_LINE(803)
		{
			...
			int _g = (int)0;		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(803)
			::flixel::_system::frontEnds::PluginFrontEnd tmp9 = ::flixel::FlxG_obj::plugins;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(803)
			Array< ::Dynamic > _g1 = tmp9->__Field(HX_HCSTRING("list","\x5e","\x1c","\xb3","\x47"), hx::paccDynamic );		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(803)
			while((true)){
				...
				HX_STACK_LINE(803)
				::flixel::plugin::FlxPlugin tmp12 = _g1->__get(_g).StaticCast< ::flixel::plugin::FlxPlugin >();		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(803)
				::flixel::plugin::FlxPlugin plugin = tmp12;		HX_STACK_VAR(plugin,"plugin");
				HX_STACK_LINE(803)
				++(_g);
				HX_STACK_LINE(803)
				bool tmp13 = plugin->exists;		HX_STACK_VAR(tmp13,"tmp13");
				HX_STACK_LINE(803)
				bool tmp14;		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(803)
				if ((tmp13)){
					HX_STACK_LINE(803)
					tmp14 = plugin->visible;
				}
				else{
					HX_STACK_LINE(803)
					tmp14 = false;
		...
		HX_STACK_LINE(811)
		::flixel::_system::debug::FlxDebugger tmp10 = this->debugger;		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(811)
		int tmp11 = ::flixel::_system::layer::TileSheetExt_obj::_DRAWCALLS;		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(811)
		tmp10->__Field(HX_HCSTRING("stats","\x1f","\x76","\x0b","\x84"), hx::paccDynamic )->__Field(HX_HCSTRING("drawCalls","\x71","\xa7","\x26","\x09"), hx::paccDynamic )(tmp11);
		HX_STACK_LINE(837)
		{
			HX_STACK_LINE(837)
			int _g = (int)0;		HX_STACK_VAR(_g,"_g");
		...
		HX_STACK_LINE(842)
		::flixel::_system::debug::FlxDebugger tmp13 = this->debugger;		HX_STACK_VAR(tmp13,"tmp13");
		HX_STACK_LINE(842)
		int tmp14 = ::openfl::_legacy::Lib_obj::getTimer();		HX_STACK_VAR(tmp14,"tmp14");
		HX_STACK_LINE(842)
		int tmp15 = this->ticks;		HX_STACK_VAR(tmp15,"tmp15");
		HX_STACK_LINE(842)
		int tmp16 = (tmp14 - tmp15);		HX_STACK_VAR(tmp16,"tmp16");
		HX_STACK_LINE(842)
		tmp13->__Field(HX_HCSTRING("stats","\x1f","\x76","\x0b","\x84"), hx::paccDynamic )->__Field(HX_HCSTRING("flixelDraw","\x80","\xf8","\xdf","\x4d"), hx::paccDynamic )(tmp16);
	}
return null();
}
...
Dynamic FlxGame_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"debugger") ) { debugger=inValue.Cast< ::flixel::_system::debug::FlxDebugger >(); return inValue; }
		break;
	case 9:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::flixel::_system::debug::FlxDebugger*/ ,(int)offsetof(FlxGame_obj,debugger),HX_HCSTRING("debugger","\x21","\x24","\xeb","\x90")},
