...
bool FlxG_obj::set_fullscreen( bool Value){
	...
	if ((tmp)){
		...
		HX_STACK_LINE(572)
		tmp2->set_displayState(::openfl::_legacy::display::StageDisplayState_obj::FULL_SCREEN);
	}
	else{
		HX_STACK_LINE(576)
		::openfl::_legacy::display::MovieClip tmp1 = ::openfl::_legacy::Lib_obj::get_current();		HX_STACK_VAR(tmp1,"tmp1");
		...
		::openfl::_legacy::display::Stage tmp2 = tmp1->get_stage();		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(576)
		tmp2->set_displayState(::openfl::_legacy::display::StageDisplayState_obj::NORMAL);
	}
	HX_STACK_LINE(579)
...
bool FlxG_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		if (HX_FIELD_EQ(inName,"fullscreen") ) { if (inCallProp == hx::paccAlways)  ioValue = set_fullscreen(ioValue); else fullscreen=ioValue.Cast< bool >(); return true; }
		if (HX_FIELD_EQ(inName,"_scaleMode") ) { _scaleMode=ioValue.Cast< ::flixel::_system::scaleModes::BaseScaleMode >(); return true; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"worldBounds") ) { worldBounds=ioValue.Cast< ::flixel::util::FlxRect >(); return true; }
		break;
	case 13:
	...
	case 14:
		...
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"updateFramerate") ) { if (inCallProp == hx::paccAlways)  ioValue = set_updateFramerate(ioValue); }
	}
	return false;
}
...
void FlxG_obj::__boot()
{
	...
	VERSION= ::flixel::_system::FlxVersion_obj::__new((int)3,(int)3,(int)12,null());
	elapsed= ((Float)0);
