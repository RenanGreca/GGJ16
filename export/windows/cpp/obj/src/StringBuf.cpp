...
{
HX_STACK_FRAME("StringBuf","new",0xaaa8f4b4,"StringBuf.new","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/_std/StringBuf.hx",30,0x51b46ca5)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(30)
...
{
		HX_STACK_FRAME("StringBuf","add",0xaa9f1675,"StringBuf.add","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/_std/StringBuf.hx",40,0x51b46ca5)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(41)
