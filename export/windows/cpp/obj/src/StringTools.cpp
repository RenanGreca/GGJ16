...
::String StringTools_obj::urlEncode( ::String s){
	HX_STACK_FRAME("StringTools","urlEncode",0x06afdce1,"StringTools.urlEncode","C:\\Programming\\HaxeToolkit\\haxe\\std/StringTools.hx",36,0xa7a7c04a)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(44)
...
::String StringTools_obj::urlDecode( ::String s){
	HX_STACK_FRAME("StringTools","urlDecode",0x71b947f9,"StringTools.urlDecode","C:\\Programming\\HaxeToolkit\\haxe\\std/StringTools.hx",61,0xa7a7c04a)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(69)
...
::String StringTools_obj::htmlEscape( ::String s,Dynamic quotes){
	HX_STACK_FRAME("StringTools","htmlEscape",0x0e1a5dd0,"StringTools.htmlEscape","C:\\Programming\\HaxeToolkit\\haxe\\std/StringTools.hx",97,0xa7a7c04a)
	HX_STACK_ARG(s,"s")
...
bool StringTools_obj::startsWith( ::String s,::String start){
	HX_STACK_FRAME("StringTools","startsWith",0x5f4e6efb,"StringTools.startsWith","C:\\Programming\\HaxeToolkit\\haxe\\std/StringTools.hx",127,0xa7a7c04a)
	HX_STACK_ARG(s,"s")
...
bool StringTools_obj::endsWith( ::String s,::String end){
	HX_STACK_FRAME("StringTools","endsWith",0x0eb5bfe2,"StringTools.endsWith","C:\\Programming\\HaxeToolkit\\haxe\\std/StringTools.hx",153,0xa7a7c04a)
	HX_STACK_ARG(s,"s")
...
bool StringTools_obj::isSpace( ::String s,int pos){
	HX_STACK_FRAME("StringTools","isSpace",0xe0290778,"StringTools.isSpace","C:\\Programming\\HaxeToolkit\\haxe\\std/StringTools.hx",183,0xa7a7c04a)
	HX_STACK_ARG(s,"s")
...
::String StringTools_obj::ltrim( ::String s){
	HX_STACK_FRAME("StringTools","ltrim",0x24d2234a,"StringTools.ltrim","C:\\Programming\\HaxeToolkit\\haxe\\std/StringTools.hx",200,0xa7a7c04a)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(204)
...
::String StringTools_obj::rtrim( ::String s){
	HX_STACK_FRAME("StringTools","rtrim",0x99399e50,"StringTools.rtrim","C:\\Programming\\HaxeToolkit\\haxe\\std/StringTools.hx",225,0xa7a7c04a)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(229)
	int l = s.length;		HX_STACK_VAR(l,"l");
	HX_STACK_LINE(230)
...
::String StringTools_obj::trim( ::String s){
	HX_STACK_FRAME("StringTools","trim",0x2908d066,"StringTools.trim","C:\\Programming\\HaxeToolkit\\haxe\\std/StringTools.hx",247,0xa7a7c04a)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(253)
...
::String StringTools_obj::replace( ::String s,::String sub,::String by){
	HX_STACK_FRAME("StringTools","replace",0x6d651f30,"StringTools.replace","C:\\Programming\\HaxeToolkit\\haxe\\std/StringTools.hx",312,0xa7a7c04a)
	HX_STACK_ARG(s,"s")
