...
{
HX_STACK_FRAME("List","new",0xed890070,"List.new","C:\\Programming\\HaxeToolkit\\haxe\\std/List.hx",41,0xbca2c78a)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(41)
	this->length = (int)0;
...
{
		HX_STACK_FRAME("List","add",0xed7f2231,"List.add","C:\\Programming\\HaxeToolkit\\haxe\\std/List.hx",49,0xbca2c78a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("List","push",0xebb5efca,"List.push","C:\\Programming\\HaxeToolkit\\haxe\\std/List.hx",64,0xbca2c78a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(item,"item")
		HX_STACK_LINE(68)
...
bool List_obj::isEmpty( ){
	HX_STACK_FRAME("List","isEmpty",0xaa565653,"List.isEmpty","C:\\Programming\\HaxeToolkit\\haxe\\std/List.hx",114,0xbca2c78a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(115)
	bool tmp = (this->h == null());		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(115)
...
bool List_obj::remove( Dynamic v){
	HX_STACK_FRAME("List","remove",0x4b44d634,"List.remove","C:\\Programming\\HaxeToolkit\\haxe\\std/List.hx",138,0xbca2c78a)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(139)
