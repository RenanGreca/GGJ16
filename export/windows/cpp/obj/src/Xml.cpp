...
::String Xml_obj::get( ::String att){
	HX_STACK_FRAME("Xml","get",0x2e441e5f,"Xml.get","C:\\Programming\\HaxeToolkit\\haxe\\std/Xml.hx",166,0x53e37e1d)
	HX_STACK_THIS(this)
...
Dynamic Xml_obj::elements( ){
	HX_STACK_FRAME("Xml","elements",0x0310ffce,"Xml.elements","C:\\Programming\\HaxeToolkit\\haxe\\std/Xml.hx",229,0x53e37e1d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(230)
	{
		HX_STACK_LINE(230)
