...
cpp::ArrayBase Lambda_obj::array( Dynamic it){
	HX_STACK_FRAME("Lambda","array",0x9c8b0512,"Lambda.array","C:\\Programming\\HaxeToolkit\\haxe\\std/Lambda.hx",42,0x5dd56f01)
	HX_STACK_ARG(it,"it")
	HX_STACK_LINE(43)
...
bool Lambda_obj::has( Dynamic it,Dynamic elt){
	HX_STACK_FRAME("Lambda","has",0x3d8bd693,"Lambda.has","C:\\Programming\\HaxeToolkit\\haxe\\std/Lambda.hx",98,0x5dd56f01)
	HX_STACK_ARG(it,"it")
