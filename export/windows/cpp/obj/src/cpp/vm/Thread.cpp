...
{
HX_STACK_FRAME("cpp.vm.Thread","new",0x66262c28,"cpp.vm.Thread.new","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/vm/Thread.hx",31,0xb118f9de)
HX_STACK_THIS(this)
HX_STACK_ARG(h,"h")
{
	HX_STACK_LINE(31)
...
{
		HX_STACK_FRAME("cpp.vm.Thread","sendMessage",0x48dced27,"cpp.vm.Thread.sendMessage","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/vm/Thread.hx",38,0xb118f9de)
		HX_STACK_THIS(this)
...
int Thread_obj::__compare( Dynamic t){
	HX_STACK_FRAME("cpp.vm.Thread","__compare",0x3204cb4d,"cpp.vm.Thread.__compare","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/vm/Thread.hx",65,0xb118f9de)
	HX_STACK_THIS(this)
	HX_STACK_ARG(t,"t")
	HX_STACK_LINE(66)
...
::cpp::vm::Thread Thread_obj::current( ){
	HX_STACK_FRAME("cpp.vm.Thread","current",0x21a37c01,"cpp.vm.Thread.current","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/vm/Thread.hx",45,0xb118f9de)
	HX_STACK_LINE(46)
...
::cpp::vm::Thread Thread_obj::create( Dynamic callb){
	HX_STACK_FRAME("cpp.vm.Thread","create",0xb01a9834,"cpp.vm.Thread.create","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/vm/Thread.hx",52,0xb118f9de)
...
Dynamic Thread_obj::readMessage( bool block){
	HX_STACK_FRAME("cpp.vm.Thread","readMessage",0x11bc2cd9,"cpp.vm.Thread.readMessage","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/vm/Thread.hx",61,0xb118f9de)
