...
Dynamic Lib_obj::load( ::String lib,::String prim,int nargs){
	HX_STACK_FRAME("cpp.Lib","load",0xd2b2dcba,"cpp.Lib.load","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/Lib.hx",30,0xe7694f1b)
...
Dynamic Lib_obj::loadLazy( ::String lib,::String prim,int nargs){
	HX_STACK_FRAME("cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/Lib.hx",65,0xe7694f1b)
	HX_STACK_ARG(lib,"lib")
	HX_STACK_ARG(prim,"prim")
	HX_STACK_ARG(nargs,"nargs")
	HX_STACK_LINE(66)
			...
			Dynamic e = __e;{
				...
				switch( (int)(tmp)){
					case (int)0: {
						...
						Void run(){
							HX_STACK_FRAME("*","_Function_3_1",0x520271b9,"*._Function_3_1","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/Lib.hx",70,0xe7694f1b)
							{
								HX_STACK_LINE(70)
					...
					case (int)2: {
						...
						Void run(Dynamic _1,Dynamic _2){
							HX_STACK_FRAME("*","_Function_3_1",0x520271b9,"*._Function_3_1","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/Lib.hx",71,0xe7694f1b)
							HX_STACK_ARG(_1,"_1")
							HX_STACK_ARG(_2,"_2")
							{
								HX_STACK_LINE(71)
					...
					case (int)3: {
						...
						Void run(Dynamic _1,Dynamic _2,Dynamic _3){
							HX_STACK_FRAME("*","_Function_3_1",0x520271b9,"*._Function_3_1","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/Lib.hx",72,0xe7694f1b)
							HX_STACK_ARG(_1,"_1")
							HX_STACK_ARG(_2,"_2")
							HX_STACK_ARG(_3,"_3")
							{
					...
					case (int)4: {
						...
						Void run(Dynamic _1,Dynamic _2,Dynamic _3,Dynamic _4){
							HX_STACK_FRAME("*","_Function_3_1",0x520271b9,"*._Function_3_1","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/Lib.hx",73,0xe7694f1b)
							HX_STACK_ARG(_1,"_1")
							HX_STACK_ARG(_2,"_2")
							HX_STACK_ARG(_3,"_3")
							HX_STACK_ARG(_4,"_4")
					...
					case (int)5: {
						...
						Void run(Dynamic _1,Dynamic _2,Dynamic _3,Dynamic _4,Dynamic _5){
							HX_STACK_FRAME("*","_Function_3_1",0x520271b9,"*._Function_3_1","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/Lib.hx",74,0xe7694f1b)
							HX_STACK_ARG(_1,"_1")
							HX_STACK_ARG(_2,"_2")
							HX_STACK_ARG(_3,"_3")
							HX_STACK_ARG(_4,"_4")
					...
					default: {
						...
						Void run(Dynamic _1){
							HX_STACK_FRAME("*","_Function_3_1",0x520271b9,"*._Function_3_1","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/Lib.hx",75,0xe7694f1b)
							HX_STACK_ARG(_1,"_1")
							{
								HX_STACK_LINE(75)
								Dynamic tmp1 = e;		HX_STACK_VAR(tmp1,"tmp1");
