...
{
HX_STACK_FRAME("haxe.format.JsonParser","new",0xa017eec8,"haxe.format.JsonParser.new","C:\\Programming\\HaxeToolkit\\haxe\\std/haxe/format/JsonParser.hx",49,0x2c3c1092)
HX_STACK_THIS(this)
...
Dynamic JsonParser_obj::parseRec( ){
	HX_STACK_FRAME("haxe.format.JsonParser","parseRec",0xda258b75,"haxe.format.JsonParser.parseRec","C:\\Programming\\HaxeToolkit\\haxe\\std/haxe/format/JsonParser.hx",55,0x2c3c1092)
	HX_STACK_THIS(this)
	HX_STACK_LINE(55)
	while((true)){
		HX_STACK_LINE(56)
			...
			case (int)123: {
				struct _Function_3_1{
					inline static Dynamic Block( ){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\Programming\\HaxeToolkit\\haxe\\std/haxe/format/JsonParser.hx",61,0x2c3c1092)
						{
...
::String JsonParser_obj::parseString( ){
	HX_STACK_FRAME("haxe.format.JsonParser","parseString",0x8c919bcc,"haxe.format.JsonParser.parseString","C:\\Programming\\HaxeToolkit\\haxe\\std/haxe/format/JsonParser.hx",136,0x2c3c1092)
	HX_STACK_THIS(this)
	HX_STACK_LINE(137)
...
{
		HX_STACK_FRAME("haxe.format.JsonParser","invalidChar",0xa9f373d5,"haxe.format.JsonParser.invalidChar","C:\\Programming\\HaxeToolkit\\haxe\\std/haxe/format/JsonParser.hx",247,0x2c3c1092)
		HX_STACK_THIS(this)
		HX_STACK_LINE(248)
		(this->pos)--;
		HX_STACK_LINE(249)
...
{
		HX_STACK_FRAME("haxe.format.JsonParser","invalidNumber",0x8e9d1988,"haxe.format.JsonParser.invalidNumber","C:\\Programming\\HaxeToolkit\\haxe\\std/haxe/format/JsonParser.hx",252,0x2c3c1092)
		HX_STACK_THIS(this)
