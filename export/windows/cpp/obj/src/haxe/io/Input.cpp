...
int Input_obj::readByte( ){
	HX_STACK_FRAME("haxe.io.Input","readByte",0x4de8a3c2,"haxe.io.Input.readByte","C:\\Programming\\HaxeToolkit\\haxe\\std/haxe/io/Input.hx",48,0x5d8b852a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(48)
...
{
		HX_STACK_FRAME("haxe.io.Input","close",0xfc421af4,"haxe.io.Input.close","C:\\Programming\\HaxeToolkit\\haxe\\std/haxe/io/Input.hx",87,0x5d8b852a)
		HX_STACK_THIS(this)
	}
return null();
}
...
::String Input_obj::readLine( ){
	HX_STACK_FRAME("haxe.io.Input","readLine",0x54789cae,"haxe.io.Input.readLine","C:\\Programming\\HaxeToolkit\\haxe\\std/haxe/io/Input.hx",171,0x5d8b852a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(172)
