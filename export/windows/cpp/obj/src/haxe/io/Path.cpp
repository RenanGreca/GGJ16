...
{
HX_STACK_FRAME("haxe.io.Path","new",0x1b96d677,"haxe.io.Path.new","C:\\Programming\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",76,0x73a946c3)
HX_STACK_THIS(this)
...
::String Path_obj::directory( ::String path){
	HX_STACK_FRAME("haxe.io.Path","directory",0xbcfe23c4,"haxe.io.Path.directory","C:\\Programming\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",147,0x73a946c3)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(148)
...
::String Path_obj::addTrailingSlash( ::String path){
	HX_STACK_FRAME("haxe.io.Path","addTrailingSlash",0x8b4f8e69,"haxe.io.Path.addTrailingSlash","C:\\Programming\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",265,0x73a946c3)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(266)
...
::String Path_obj::removeTrailingSlashes( ::String path){
	HX_STACK_FRAME("haxe.io.Path","removeTrailingSlashes",0x2dc73462,"haxe.io.Path.removeTrailingSlashes","C:\\Programming\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",290,0x73a946c3)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(291)
	while((true)){
		HX_STACK_LINE(292)
