...
{
		HX_STACK_FRAME("haxe.io.Output","writeByte",0xb4fe513a,"haxe.io.Output.writeByte","C:\\Programming\\HaxeToolkit\\haxe\\std/haxe/io/Output.hx",47,0x669f1567)
		HX_STACK_THIS(this)
		HX_STACK_ARG(c,"c")
		HX_STACK_LINE(47)
...
int Output_obj::writeBytes( ::haxe::io::Bytes s,int pos,int len){
	HX_STACK_FRAME("haxe.io.Output","writeBytes",0xa988c1f9,"haxe.io.Output.writeBytes","C:\\Programming\\HaxeToolkit\\haxe\\std/haxe/io/Output.hx",57,0x669f1567)
	HX_STACK_THIS(this)
	HX_STACK_ARG(s,"s")
...
{
		HX_STACK_FRAME("haxe.io.Output","close",0xe726bfeb,"haxe.io.Output.close","C:\\Programming\\HaxeToolkit\\haxe\\std/haxe/io/Output.hx",91,0x669f1567)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("haxe.io.Output","write",0x6f1d1512,"haxe.io.Output.write","C:\\Programming\\HaxeToolkit\\haxe\\std/haxe/io/Output.hx",104,0x669f1567)
		HX_STACK_THIS(this)
		HX_STACK_ARG(s,"s")
		HX_STACK_LINE(105)
...
{
		HX_STACK_FRAME("haxe.io.Output","writeFullBytes",0xc2c420ea,"haxe.io.Output.writeFullBytes","C:\\Programming\\HaxeToolkit\\haxe\\std/haxe/io/Output.hx",121,0x669f1567)
		HX_STACK_THIS(this)
		HX_STACK_ARG(s,"s")
		HX_STACK_ARG(pos,"pos")
		HX_STACK_ARG(len,"len")
...
{
		HX_STACK_FRAME("haxe.io.Output","writeString",0x97e1cb83,"haxe.io.Output.writeString","C:\\Programming\\HaxeToolkit\\haxe\\std/haxe/io/Output.hx",276,0x669f1567)
		HX_STACK_THIS(this)
		HX_STACK_ARG(s,"s")
		HX_STACK_LINE(280)
