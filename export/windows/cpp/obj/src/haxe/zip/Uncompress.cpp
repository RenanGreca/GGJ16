...
{
HX_STACK_FRAME("haxe.zip.Uncompress","new",0x34f307c2,"haxe.zip.Uncompress.new","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/zip/Uncompress.hx",28,0x2365f4d5)
HX_STACK_THIS(this)
...
Dynamic Uncompress_obj::execute( ::haxe::io::Bytes src,int srcPos,::haxe::io::Bytes dst,int dstPos){
	HX_STACK_FRAME("haxe.zip.Uncompress","execute",0xb3589a97,"haxe.zip.Uncompress.execute","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/zip/Uncompress.hx",32,0x2365f4d5)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxe.zip.Uncompress","setFlushMode",0xbecba0a3,"haxe.zip.Uncompress.setFlushMode","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/zip/Uncompress.hx",36,0x2365f4d5)
		HX_STACK_THIS(this)
		HX_STACK_ARG(f,"f")
		HX_STACK_LINE(37)
		Dynamic tmp = this->s;		HX_STACK_VAR(tmp,"tmp");
...
{
		HX_STACK_FRAME("haxe.zip.Uncompress","close",0x4cc86b9a,"haxe.zip.Uncompress.close","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/zip/Uncompress.hx",40,0x2365f4d5)
		HX_STACK_THIS(this)
		HX_STACK_LINE(41)
		Dynamic tmp = this->s;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(41)
...
::haxe::io::Bytes Uncompress_obj::run( ::haxe::io::Bytes src,Dynamic bufsize){
	HX_STACK_FRAME("haxe.zip.Uncompress","run",0x34f61ead,"haxe.zip.Uncompress.run","C:\\Programming\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/zip/Uncompress.hx",44,0x2365f4d5)
	HX_STACK_ARG(src,"src")
