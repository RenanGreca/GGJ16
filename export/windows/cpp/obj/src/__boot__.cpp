...
::flixel::_system::layer::frames::FrameType_obj::__register();
...
::flixel::_system::layer::frames::FlxFrame_obj::__register();
::flixel::_system::layer::TileSheetExt_obj::__register();
...
::flixel::_system::ui::FlxSystemButton_obj::__register();
::flixel::_system::ui::FlxSoundTray_obj::__register();
::flixel::_system::ui::FlxFocusLostScreen_obj::__register();
::flixel::_system::replay::MouseRecord_obj::__register();
::flixel::_system::replay::FrameRecord_obj::__register();
::flixel::_system::replay::FlxReplay_obj::__register();
::flixel::_system::replay::CodeValuePair_obj::__register();
::flixel::_system::layer::frames::FlxSpriteFrames_obj::__register();
::flixel::_system::layer::frames::FlxRotatedFrame_obj::__register();
::openfl::_legacy::geom::Matrix_obj::__register();
::flixel::_system::layer::_TileSheetExt::RectPointTileID_obj::__register();
...
::flixel::_system::frontEnds::SoundFrontEnd_obj::__register();
::flixel::_system::frontEnds::SignalFrontEnd_obj::__register();
...
::flixel::_system::frontEnds::PluginFrontEnd_obj::__register();
::flixel::_system::frontEnds::LogFrontEnd_obj::__register();
::flixel::_system::frontEnds::InputFrontEnd_obj::__register();
::flixel::util::_FlxSignal::FlxTypedSignal_Impl__obj::__register();
::flixel::_system::frontEnds::DebuggerFrontEnd_obj::__register();
::flixel::_system::frontEnds::ConsoleFrontEnd_obj::__register();
::openfl::_legacy::geom::Rectangle_obj::__register();
::flixel::_system::frontEnds::CameraFrontEnd_obj::__register();
...
::flixel::_system::layer::frames::FrameType_obj::__boot();
::flixel::_system::debug::DebuggerLayout_obj::__boot();
::flixel::_system::debug::ButtonAlignment_obj::__boot();
...
::flixel::_system::layer::TileSheetExt_obj::__boot();
::flixel::_system::layer::frames::FlxFrame_obj::__boot();
