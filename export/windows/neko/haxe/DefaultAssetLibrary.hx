...
@:font("C:/Programming/HaxeToolkit/haxe/lib/flixel/3,3,12/assets/fonts/nokiafc22.ttf") @:keep #if display private #end class __ASSET__assets_fonts_nokiafc22_ttf extends flash.text.Font {}
@:font("C:/Programming/HaxeToolkit/haxe/lib/flixel/3,3,12/assets/fonts/arial.ttf") @:keep #if display private #end class __ASSET__assets_fonts_arial_ttf extends flash.text.Font {}
...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		var id;
		id = "assets/data/tilemap/ggj.tmx";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/data/tilemap/tilemap_Box.csv";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/data/tilemap/tilemap_Details.csv";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/data/tilemap/tilemap_Objects.csv";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/data/tilemap/tilemap_Platforms.csv";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/data/tilemap/tileset.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/images-go-here.txt";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/images/tileset.jpg";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
...
@:font("C:/Programming/HaxeToolkit/haxe/lib/flixel/3,3,12/assets/fonts/nokiafc22.ttf") #if display private #end class __ASSET__assets_fonts_nokiafc22_ttf extends lime.text.Font {}
@:font("C:/Programming/HaxeToolkit/haxe/lib/flixel/3,3,12/assets/fonts/arial.ttf") #if display private #end class __ASSET__assets_fonts_arial_ttf extends lime.text.Font {}
