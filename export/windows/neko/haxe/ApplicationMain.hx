...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "GGJ2016_GAME", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "GGJ2016_GAME";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "GGJ2016_GAME", null, { width: 768, height: 640 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 768, height: 640 });
			#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 768, 640, "null");
		#end
		#else
		create ();
		#end
